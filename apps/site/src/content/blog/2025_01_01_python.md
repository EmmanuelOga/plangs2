...
| Tool | Notes |
| --- | --- |
| (tool+mypy) | One of the earliest static type checkers for (pl+python) and has been widely adopted by the community. |
| (tool+pyright) | Generally found to be faster and stricter by default than MyPy. |
