...
export const FACETS: FacetsMap<FK> = defineFacets<FK>(
  ...
  table("compilesTo", "Compiles To", { kind: "noderel", edge: "plangRelCompilesTo", dir: "direct" }),
  table("creationYear", "Creation Year", { kind: "year", node: "plang" }),
  table("dialectOf", "Dialect Of", { kind: "noderel", edge: "plangRelDialectOf", dir: "direct" }),
  table("implements", "Implements", { kind: "noderel", edge: "plangRelImplements", dir: "direct" }),
  table("influenced", "Influenced", { kind: "noderel", edge: "plangRelInfluencedBy", dir: "inverse" }),
  table("influencedBy", "Influenced By", { kind: "noderel", edge: "plangRelInfluencedBy", dir: "direct" }),
  table("licenses", "Licenses", { kind: "noderel", edge: "licenseRelPlangs", dir: "direct" }),
  table("paradigms", "Paradigms", { kind: "noderel", edge: "plangRelParadigms", dir: "direct" }),
  table("platforms", "Platforms", { kind: "noderel", edge: "plangRelPlatforms", dir: "direct" }),
  table("tags", "Tags", { kind: "noderel", edge: "tagRelPlangs", dir: "inverse" }),
  table("typeSystems", "Type Systems", { kind: "noderel", edge: "plangRelTypeSystems", dir: "direct" }),
  table("writtenIn", "Written In", { kind: "noderel", edge: "plangRelWrittenWith", dir: "direct" }),
