...
import type { VLicense, VParadigm, VPlang, VPlatform, VTag, VTypeSystem } from "@plangs/plangs";
...
export const PLANG_FACET_PREDICATES = {
  ...
  typeSystems: (({ relTsys }, flt) => flt.matches(key => relTsys.has(key))) as Pred<Filter<VTypeSystem["key"]>>,
