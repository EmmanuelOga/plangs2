...
export const PLANGS_GRAPH_SPEC: GenGraphSpec<PlangVertexNames> = {
  ...
  edges: [
    ...
    { from: "plang", to: "plang", name: "dialectOf", desc: "Plangs is a Dialect of another." },
    { from: "plang", to: "plang", name: "implements", desc: "Plangs is an implementation of another." },
    { from: "plang", to: "plang", name: "influencedBy", desc: "Plangs that influenced this Plang." },
