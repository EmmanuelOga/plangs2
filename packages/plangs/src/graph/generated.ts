/**  Do not modify manually! Generated by graphgen on 2024-11-26T14:33:15.706Z. */
...
export class PlangsGraphBase {
  ...
  readonly edges = {
    ...
    libraryPlang: new Edges<`lib+${string}`, `pl+${string}`>(),
...
export class VLibraryBase extends PlangsVertex<"lib", VLibraryData> {
  ...
  get relPlang() {
    return new RelFrom(this, this.graph.edges.libraryPlang, this.graph.plang);
  }
...
export class VPlangBase extends PlangsVertex<"pl", VPlangData> {
  ...
  get relLibrary() {
    return new RelTo(this, this.graph.edges.libraryPlang, this.graph.library);
  }
