/**  Do not modify manually! Generated by graphgen on 2024-12-11T00:40:06.884Z. */
...
/** Every Vertex Name. */
export type TPlangsVertexName = keyof TPlangsVClassByName;

/** Every Generated Vertex Class. */
export type TPlangsVertexClass = TPlangsVClassByName[TPlangsVertexName];
...
export abstract class VParadigmBase extends PlangsVertex<"para", VD.VParadigmData> {
  ...
  static readonly relConfig = { relPlangs: { edgeName: "plangRelParadigms", direction: "inverse" } } as const;
...
export abstract class VTypeSystemBase extends PlangsVertex<"tsys", VD.VTypeSystemData> {
  ...
  static readonly relConfig = { relPlangs: { edgeName: "plangRelTypeSystems", direction: "inverse" } } as const;
