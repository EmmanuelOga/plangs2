/**  Do not modify manually! Generated by graphgen on 2025-01-02T03:44:58.555Z. */
...
export class PlangsGraphBase {
  ...
  readonly edges = {
    ...
    tagRelApps: new Edges(this.tag, this.app, "Apps", "Tags"),
...
export abstract class VTagBase extends PlangsVertex<"tag", VD.VTagData> {
  ...
  /** Apps `(this:VTag)-[tagRelApps]->VApp`. Inverse: {@link VC.VApp.relTags}. */
  get relApps() {
