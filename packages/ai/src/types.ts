...
import type { VPlangBaseData, VertexBaseData } from "@plangs/plangs/graph/vertex_data_schemas";

/**
 * Data for an NPlang vertex generated by OpenAI.
...
export type NPlangAI = {
  ...
  basicPlangData: Partial<VPlangBaseData>;
