...
` + f2(this.__v)), b2.call(this, n2);
  ...
  c4.__b = function(n2) {
    ...
    i7 && (u4 === r3 ? (i7.__h = [], r3.__h = [], i7.__.forEach(function(n3) {
      n3.__N && (n3.__ = n3.__N), n3.i = n3.__N = void 0;
    })) : (i7.__h.forEach(z2), i7.__h.forEach(B2), i7.__h = [], t2 = 0)), u4 = r3;
  }, c4.diffed = function(n2) {
    v3 && v3(n2);
    var t3 = n2.__c;
    t3 && t3.__H && (t3.__H.__h.length && (1 !== f3.push(t3) && i5 === c4.requestAnimationFrame || ((i5 = c4.requestAnimationFrame) || w3)(j2)), t3.__H.__.forEach(function(n3) {
  ...
  function u5(e3, t3, n2, o4, i7, u6) {
    t3 || (t3 = {});
    var a5, c5, p5 = t3;
    if ("ref" in p5) for (c5 in p5 = {}, t3) "ref" == c5 ? a5 = t3[c5] : p5[c5] = t3[c5];
    var l5 = { type: e3, props: p5, key: n2, ref: a5, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, constructor: void 0, __v: --f4, __i: -1, __u: 0, __source: i7, __self: u6 };
    ...
    return /* @__PURE__ */ u5(k, { children: [
      ...
      /* @__PURE__ */ u5(
        "div",
        {
          ...
          ref: popupRef,
          tabindex: 0,
          children: state.candidates.map((complIdx, idx) => /* @__PURE__ */ u5(
            "div",
            {
  ...
  function PlInfo({ pg, pl, header }) {
    ...
    let content;
    if (!pl) {
      content = /* @__PURE__ */ u5("p", { children: "Select a language to show more information." });
    } else if (!pg) {
      content = /* @__PURE__ */ u5("p", { children: "Loading graph ..." });
    } else if (!pl) {
      ...
      content = /* @__PURE__ */ u5(k, { children: [
        ...
        /* @__PURE__ */ u5("dl", { class: "readable", children: [
          ...
          pl.relInfluencedBy.tap((rel) => /* @__PURE__ */ u5(Entry, { title: "Influenced By", children: rel.values.map(({ toPl }) => toPl && Pill(toPl)) })),
          pl.relInfluenced.tap((rel) => /* @__PURE__ */ u5(Entry, { title: "Influenced", children: rel.values.map(({ fromPl }) => fromPl && Pill(fromPl)) })),
          pl.relDialectOf.tap((rel) => /* @__PURE__ */ u5(Entry, { title: "Dialect Of", children: rel.values.map(({ toPl }) => toPl && Pill(toPl)) })),
          pl.relImplements.tap((rel) => /* @__PURE__ */ u5(Entry, { title: "Standard For", children: rel.values.map(({ toPl }) => toPl && Pill(toPl)) })),
          pl.relLicenses.tap((rel) => /* @__PURE__ */ u5(Entry, { title: "Licenses", children: rel.values.map(({ license }) => license && Pill(license)) })),
          pl.extensions.tap((extensions) => /* @__PURE__ */ u5(Entry, { title: "Extensions", children: extensions.map((name) => Pill({ key: name, name, kind: "ext" })) }))
        ] })
      ] });
    }
  ...
  function startBrowseNav(pg, dom) {
    ...
    const extensions = dom.inputs.extensions;
