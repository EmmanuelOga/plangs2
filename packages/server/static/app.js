...
(() => {
  ...
  function _(l5, u6, t3) {
    ...
    if (
      (arguments.length > 2 && (f5.children = arguments.length > 3 ? n.call(arguments, 2) : t3), "function" == typeof l5 && null != l5.defaultProps)
    )
      for (r4 in l5.defaultProps) void 0 === f5[r4] && (f5[r4] = l5.defaultProps[r4]);
  ...
  function C(n2) {
    ...
    if (null != (n2 = n2.__) && null != n2.__c) {
      for (n2.__e = n2.__c.base = null, l5 = 0; l5 < n2.__k.length; l5++)
        if (null != (u6 = n2.__k[l5]) && null != u6.__e) {
  ...
  function P() {
    ...
    for (i.sort(f); (n2 = i.shift()); )
      n2.__d &&
        ...
        (s5 = []),
        t3.__P &&
          (((o4 = d({}, r4)).__v = r4.__v + 1),
          l.vnode && l.vnode(o4),
          O(t3.__P, o4, r4, t3.__n, t3.__P.namespaceURI, 32 & r4.__u ? [e3] : null, c5, null == e3 ? x(r4) : e3, !!(32 & r4.__u), s5),
          (o4.__v = r4.__v),
          (o4.__.__k[o4.__i] = o4),
          j(c5, o4, s5),
          o4.__e != e3 && C(o4)),
        i.length > u6 && i.sort(f));
    P.__r = 0;
  }
  function S(n2, l5, u6, t3, i7, o4, r4, f5, e3, c5, s5) {
    var a5,
      ...
      _2 = (t3 && t3.__k) || p,
      g2 = l5.length;
    for (u6.__d = e3, $(u6, l5, _2), e3 = u6.__d, a5 = 0; a5 < g2; a5++)
      null != (y4 = u6.__k[a5]) &&
        "boolean" != typeof y4 &&
        "function" != typeof y4 &&
        ((v4 = -1 === y4.__i ? h : _2[y4.__i] || h),
        (y4.__i = a5),
        O(n2, y4, v4, i7, o4, r4, f5, e3, c5, s5),
        (d4 = y4.__e),
        y4.ref && v4.ref != y4.ref && (v4.ref && N(v4.ref, null, y4), s5.push(y4.ref, y4.__c || d4, y4)),
  ...
  function $(n2, l5, u6) {
    ...
    for (n2.__k = [], t3 = 0; t3 < e3; t3++)
      (r4 = t3 + a5),
        null !=
        (i7 = n2.__k[t3] =
          null == (i7 = l5[t3]) || "boolean" == typeof i7 || "function" == typeof i7
            ? null
            : "string" == typeof i7 || "number" == typeof i7 || "bigint" == typeof i7 || i7.constructor == String
              ? g(null, i7, null, null, null)
              : y(i7)
                ? g(k, { children: i7 }, null, null, null)
                : void 0 === i7.constructor && i7.__b > 0
                  ? g(i7.type, i7.props, i7.key, i7.ref ? i7.ref : null, i7.__v)
                  : i7)
          ? ((i7.__ = n2),
            (i7.__b = n2.__b + 1),
            (f5 = L(i7, u6, r4, s5)),
            (i7.__i = f5),
            (o4 = null),
            -1 !== f5 && (s5--, (o4 = u6[f5]) && (o4.__u |= 131072)),
            null == o4 || null === o4.__v
              ? (-1 == f5 && a5--, "function" != typeof i7.type && (i7.__u |= 65536))
              : f5 !== r4 &&
                (f5 == r4 - 1
                  ? a5--
                  : f5 == r4 + 1
                    ...
                    : f5 > r4
                      ? s5 > e3 - r4
                        ? (a5 += f5 - r4)
                        : a5--
                      : f5 < r4 && (f5 == r4 - a5 ? (a5 -= f5 - r4) : a5++),
                f5 !== t3 + a5 && (i7.__u |= 65536)))
          : (o4 = u6[r4]) &&
            null == o4.key &&
            o4.__e &&
            0 == (131072 & o4.__u) &&
            (o4.__e == n2.__d && (n2.__d = x(o4)), V(o4, o4, false), (u6[r4] = null), s5--);
  ...
  function A(n2, l5, u6, t3, i7) {
    var o4;
    n: if ("style" === l5)
      if ("string" == typeof u6) n2.style.cssText = u6;
      else {
      ...
      (o4 = l5 !== (l5 = l5.replace(/(PointerCapture)$|Capture$/i, "$1"))),
        (l5 = l5.toLowerCase() in n2 || "onFocusOut" === l5 || "onFocusIn" === l5 ? l5.toLowerCase().slice(2) : l5.slice(2)),
        n2.l || (n2.l = {}),
        (n2.l[l5 + o4] = u6),
        u6 ? (t3 ? (u6.u = t3.u) : ((u6.u = e), n2.addEventListener(l5, o4 ? s : c, o4))) : n2.removeEventListener(l5, o4 ? s : c, o4);
    else {
      ...
      "function" == typeof u6 ||
        (null == u6 || (false === u6 && "-" !== l5[4]) ? n2.removeAttribute(l5) : n2.setAttribute(l5, "popover" == l5 && 1 == u6 ? "" : u6));
    }
  }
  function F(n2) {
    return function (u6) {
  ...
  function O(n2, u6, t3, i7, o4, r4, f5, e3, c5, s5) {
    ...
    n: if ("function" == typeof T3)
      try {
        if (
          ((m3 = u6.props),
          (x2 = "prototype" in T3 && T3.prototype.render),
          (C3 = (a5 = T3.contextType) && i7[a5.__c]),
          (M2 = a5 ? (C3 ? C3.props.value : a5.__) : i7),
          t3.__c
            ? (g2 = (h3 = u6.__c = t3.__c).__ = h3.__E)
            : (x2 ? (u6.__c = h3 = new T3(m3, M2)) : ((u6.__c = h3 = new b(m3, M2)), (h3.constructor = T3), (h3.render = q)),
              C3 && C3.sub(h3),
              (h3.props = m3),
              h3.state || (h3.state = {}),
              (h3.context = M2),
          ...
          x2 &&
            ...
            (h3.__s == h3.state && (h3.__s = d({}, h3.__s)), d(h3.__s, T3.getDerivedStateFromProps(m3, h3.__s))),
          (v4 = h3.props),
          (w4 = h3.state),
          (h3.__v = u6),
          p5)
        )
          x2 && null == T3.getDerivedStateFromProps && null != h3.componentWillMount && h3.componentWillMount(),
            x2 && null != h3.componentDidMount && h3.__h.push(h3.componentDidMount);
        else {
          if (
            (x2 && null == T3.getDerivedStateFromProps && m3 !== v4 && null != h3.componentWillReceiveProps && h3.componentWillReceiveProps(m3, M2),
            !h3.__e && ((null != h3.shouldComponentUpdate && false === h3.shouldComponentUpdate(m3, h3.__s, M2)) || u6.__v === t3.__v))
          ) {
            for (
              u6.__v !== t3.__v && ((h3.props = m3), (h3.state = h3.__s), (h3.__d = false)),
                u6.__e = t3.__e,
                u6.__k = t3.__k,
                u6.__k.forEach(function (n3) {
                  n3 && (n3.__ = u6);
                }),
                P2 = 0;
              P2 < h3._sb.length;
          ...
          null != h3.componentWillUpdate && h3.componentWillUpdate(m3, h3.__s, M2),
            x2 &&
        ...
        if (((h3.context = M2), (h3.props = m3), (h3.__P = n2), (h3.__e = false), ($3 = l.__r), (I2 = 0), x2)) {
          for (h3.state = h3.__s, h3.__d = false, $3 && $3(u6), a5 = h3.render(h3.props, h3.state, h3.context), H = 0; H < h3._sb.length; H++)
        ...
        (h3.state = h3.__s),
          null != h3.getChildContext && (i7 = d(d({}, i7), h3.getChildContext())),
          x2 && !p5 && null != h3.getSnapshotBeforeUpdate && (_2 = h3.getSnapshotBeforeUpdate(v4, w4)),
          S(n2, y((L2 = null != a5 && a5.type === k && null == a5.key ? a5.props.children : a5)) ? L2 : [L2], u6, t3, i7, o4, r4, f5, e3, c5, s5),
          (h3.base = u6.__e),
          (u6.__u &= -161),
          h3.__h.length && f5.push(h3),
  ...
  function z(l5, u6, t3, i7, o4, r4, f5, e3, c5) {
    ...
    if (
      ...
      for (s5 = 0; s5 < r4.length; s5++)
        if ((d4 = r4[s5]) && "setAttribute" in d4 == !!b3 && (b3 ? d4.localName === b3 : 3 === d4.nodeType)) {
          (l5 = d4), (r4[s5] = null);
          break;
        }
    }
    ...
    if (null === b3) m3 === k3 || (e3 && l5.data === k3) || (l5.data = k3);
      ...
      if (((r4 = r4 && n.call(l5.childNodes)), (m3 = t3.props || h), !e3 && null != r4))
        for (m3 = {}, s5 = 0; s5 < l5.attributes.length; s5++) m3[(d4 = l5.attributes[s5]).name] = d4.value;
      for (s5 in m3)
          ...
          "children" == s5
            ...
            : "dangerouslySetInnerHTML" == s5
              ...
              : "value" == s5
                ...
                : "checked" == s5
                  ? (g2 = d4)
                  : "key" === s5 || (e3 && "function" != typeof d4) || m3[s5] === d4 || A(l5, s5, d4, m3[s5], o4);
      if (a5) e3 || (p5 && (a5.__html === p5.__html || a5.__html === l5.innerHTML)) || (l5.innerHTML = a5.__html), (u6.__k = []);
        ...
        S(
          ...
          t3,
          i7,
          "foreignObject" === b3 ? "http://www.w3.org/1999/xhtml" : o4,
          r4,
          f5,
      ...
      e3 ||
        ((s5 = "value"),
        void 0 !== _2 && (_2 !== l5[s5] || ("progress" === b3 && !_2) || ("option" === b3 && _2 !== m3[s5])) && A(l5, s5, _2, m3[s5], o4),
        (s5 = "checked"),
        void 0 !== g2 && g2 !== l5[s5] && A(l5, s5, g2, m3[s5], o4));
    }
    return l5;
  }
  function N(n2, u6, t3) {
  ...
  function B(u6, t3, i7) {
    var o4, r4, f5, e3;
    l.__ && l.__(u6, t3),
      (r4 = (o4 = "function" == typeof i7) ? null : (i7 && i7.__k) || t3.__k),
      (f5 = []),
      (e3 = []),
      O(
        t3,
        (u6 = ((!o4 && i7) || t3).__k = _(k, null, [u6])),
        r4 || h,
        h,
        t3.namespaceURI,
        !o4 && i7 ? [i7] : r4 ? null : t3.firstChild ? n.call(t3.childNodes) : null,
        f5,
        !o4 && i7 ? i7 : r4 ? r4.__e : t3.firstChild,
        o4,
        e3,
      ),
      j(f5, u6, e3);
  ...
  function E(l5, u6, t3) {
    var i7,
      ...
      f5,
      e3 = d({}, l5.props);
    for (r4 in (l5.type && l5.type.defaultProps && (f5 = l5.type.defaultProps), u6))
      "key" == r4 ? (i7 = u6[r4]) : "ref" == r4 ? (o4 = u6[r4]) : (e3[r4] = void 0 === u6[r4] && void 0 !== f5 ? f5[r4] : u6[r4]);
    return arguments.length > 2 && (e3.children = arguments.length > 3 ? n.call(arguments, 2) : t3), g(l5.type, e3, i7 || l5.key, o4 || l5.ref, null);
  }
  (n = p.slice),
    (l = {
      __e: function (n2, l5, u6, t3) {
        for (var i7, o4, r4; (l5 = l5.__); )
          if ((i7 = l5.__c) && !i7.__)
            try {
              if (
                ((o4 = i7.constructor) && null != o4.getDerivedStateFromError && (i7.setState(o4.getDerivedStateFromError(n2)), (r4 = i7.__d)),
                null != i7.componentDidCatch && (i7.componentDidCatch(n2, t3 || {}), (r4 = i7.__d)),
                r4)
              )
                return (i7.__E = i7);
            } catch (l6) {
    ...
    (b.prototype.setState = function (n2, l5) {
      var u6;
      (u6 = null != this.__s && this.__s !== this.state ? this.__s : (this.__s = d({}, this.state))),
        "function" == typeof n2 && (n2 = n2(d({}, u6), this.props)),
        n2 && d(u6, n2),
  ...
  var i2;
  null != (i2 = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : void 0) &&
    i2.__PREACT_DEVTOOLS__ &&
    i2.__PREACT_DEVTOOLS__.attachPreact("10.23.2", l, { Fragment: k, Component: b });
  ...
  function a2(e3) {
    return e3.type === k
      ? "Fragment"
      : "function" == typeof e3.type
        ? e3.type.displayName || e3.type.name
        : "string" == typeof e3.type
          ? e3.type
          : "#text";
  }
  var i3 = [];
  ...
  function f2(n2) {
    ...
    return e3.reduce(function (n3, e4) {
      ...
      return (
        t4
          ? (n3 += " (at " + t4.fileName + ":" + t4.lineNumber + ")")
          : l2 &&
            console.warn(
  ...
  function h2(n2) {
    return n2
      ? "function" == typeof n2.type
        ? null == n2.__
          ? null != n2.__e && null != n2.__e.parentNode
            ? n2.__e.parentNode.localName
            : ""
          : h2(n2.__)
        : n2.type
      : "";
  ...
  function w2(n2) {
    ...
    for (var r4 in e3)
      if (e3.hasOwnProperty(r4) && "children" !== r4) {
        var i7 = e3[r4];
        "function" == typeof i7 && (i7 = "function " + (i7.displayName || i7.name) + "() {}"),
          (i7 = Object(i7) !== i7 || i7.toString ? i7 + "" : Object.prototype.toString.call(i7)),
          (o4 += " " + r4 + "=" + JSON.stringify(i7));
      }
    var s5 = e3.children;
...
` + f2(this.__v),
    ...
    (function () {
      ...
      var n2 = false,
        ...
        g2 = l.__h,
        E2 = p2
          ? { useEffect: /* @__PURE__ */ new WeakMap(), useLayoutEffect: /* @__PURE__ */ new WeakMap(), lazyPropTypes: /* @__PURE__ */ new WeakMap() }
          : null,
        k3 = [];
      (l.__e = function (n3, e3, t4, o4) {
        if (e3 && e3.__c && "function" == typeof n3.then) {
          ...
          for (var i7 = e3; i7; i7 = i7.__)
            if (i7.__c && i7.__c.__c) {
              n3 = r5;
              break;
            }
        ...
        try {
          ((o4 = o4 || {}).componentStack = f2(e3)),
            v4(n3, e3, t4, o4),
            "function" != typeof n3.then &&
              setTimeout(function () {
                throw n3;
              });
        } catch (n4) {
        ...
        (l.__ = function (n3, e3) {
          ...
          if (!t4) {
            var o4 = a2(n3);
            throw new Error(
              "Expected a valid HTML node as a second argument to render.	Received " + e3 + " instead: render(<" + o4 + " />, " + e3 + ");",
            );
          }
          b3 && b3(n3, e3);
        }),
        (l.__b = function (e3) {
          ...
          if ("string" == typeof e3.type) {
            for (var i7 in e3.props)
              if ("o" === i7[0] && "n" === i7[1] && "function" != typeof e3.props[i7] && null != e3.props[i7])
                throw new Error(
                  `Component's "` +
                    i7 +
          ...
          if ("function" == typeof e3.type && e3.type.propTypes) {
            ...
            var l6 = e3.props;
            e3.type.__f &&
              delete (l6 = (function (n3, e4) {
                for (var t4 in e4) n3[t4] = e4[t4];
                return n3;
              })({}, l6)).ref,
              (function (n3, e4, t4, r6, a5) {
                Object.keys(n3).forEach(function (t5) {
                  ...
                  i8 &&
                    !(i8.message in o2) &&
                    ((o2[i8.message] = true), console.error("Failed prop type: " + i8.message + ((a5 && "\n" + a5()) || "")));
                });
      ...
      var I2 = function (n3, e3) {
        ...
        j3 = {
          nodeName: I2("nodeName", "use vnode.type"),
          attributes: I2("attributes", "use vnode.props"),
          children: I2("children", "use vnode.props.children"),
        },
        O2 = Object.create({}, j3);
      (l.vnode = function (n3) {
        var e3 = n3.props;
        ...
        (l.diffed = function (e3) {
          ...
          if (
            ...
            e3.__c === _2 && (T3 = 0),
            "string" == typeof o4 && (y2(o4) || "p" === o4 || "a" === o4 || "button" === o4))
          ) {
            var s5 = h2(i7);
            if ("" !== s5 && y2(o4))
              "table" === o4 && "td" !== s5 && y2(s5)
                ? (console.log(s5, i7.__e),
                  console.error("Improper nesting of table. Your <table> should not have a table-node parent." + w2(e3) + "\n\n" + f2(e3)))
                : ("thead" !== o4 && "tfoot" !== o4 && "tbody" !== o4) || "table" === s5
                  ? "tr" === o4 && "thead" !== s5 && "tfoot" !== s5 && "tbody" !== s5
                    ? console.error("Improper nesting of table. Your <tr> should have a <thead/tbody/tfoot> parent." + w2(e3) + "\n\n" + f2(e3))
                    : "td" === o4 && "tr" !== s5
                      ? console.error("Improper nesting of table. Your <td> should have a <tr> parent." + w2(e3) + "\n\n" + f2(e3))
                      : "th" === o4 &&
                        "tr" !== s5 &&
                        console.error("Improper nesting of table. Your <th> should have a <tr>." + w2(e3) + "\n\n" + f2(e3))
                  : console.error("Improper nesting of table. Your <thead/tbody/tfoot> should have a <table> parent." + w2(e3) + "\n\n" + f2(e3));
            else if ("p" === o4) {
              ...
              c6.length &&
                console.error(
                  "Improper nesting of paragraph. Your <p> should not have " + c6.join(", ") + "as child-elements." + w2(e3) + "\n\n" + f2(e3),
                );
            } else
              ("a" !== o4 && "button" !== o4) ||
                (-1 !== d2(e3).indexOf(o4) &&
          ...
          if (((n2 = false), r4 && r4(e3), null != e3.__k))
            for (var l6 = [], u6 = 0; u6 < e3.__k.length; u6++) {
              var p5 = e3.__k[u6];
              if (p5 && null != p5.key) {
                var v5 = p5.key;
                if (-1 !== l6.indexOf(v5)) {
  ...
  var Map2 = class {
    ...
    get size() {
      let size = 0;
      for (const [_2, map] of this.#map) size += map.size;
      return size;
    }
          ...
          t3
            ? ((this.ref = t3),
              this._listener ||
                ...
                t3.addEventListener("_preact", this._listener)))
  ...
  function preact_custom_element_esm_default(t3, e3, n2, o4) {
    ...
    return (
      ...
      (r4.prototype.connectedCallback = s3),
      (r4.prototype.attributeChangedCallback = l3),
      (r4.prototype.disconnectedCallback = u3),
        ...
        Object.defineProperty(r4.prototype, t4, {
          ...
          set: function (e4) {
            this._vdom
              ...
              : (this._props || (this._props = {}), (this._props[t4] = e4), this.connectedCallback());
            const n3 = typeof e4;
  ...
  function p4(n2, u6, i7) {
    ...
    if (
      ...
      !o4.__c &&
        ((o4.__ = [
          i7 ? i7(u6) : D2(void 0, u6),
          function (n3) {
            var t3 = o4.__N ? o4.__N[0] : o4.__[0],
              r4 = o4.t(t3, n3);
  ...
  (c4.__b = function (n2) {
    ...
    (c4.__r = function (n2) {
      ...
      i7 &&
        (u5 === r3
          ? ((i7.__h = []),
            (r3.__h = []),
            i7.__.forEach(function (n3) {
              n3.__N && (n3.__ = n3.__N), (n3.i = n3.__N = void 0);
            }))
          : (i7.__h.forEach(z2), i7.__h.forEach(B2), (i7.__h = []), (t2 = 0))),
        (u5 = r3);
    }),
    (c4.diffed = function (n2) {
      ...
      t3 &&
        t3.__H &&
        (t3.__H.__h.length && ((1 !== f4.push(t3) && i6 === c4.requestAnimationFrame) || ((i6 = c4.requestAnimationFrame) || w3)(j2)),
    ...
    return /* @__PURE__ */ u4("div", {
      ...
      children: [
        state.selected.length > 1 &&
          /* @__PURE__ */ u4("select", {
            title: "Match all or any of the elements",
            children: [
        ...
        state.selected.map(({ value, label }) =>
          /* @__PURE__ */ u4(
            "div",
            {
              ...
              children: [/* @__PURE__ */ u4("span", { "aria-label": "remove", children: "\u274C" }), label],
            },
            value,
          ),
        ),
    ...
    return /* @__PURE__ */ u4(k, {
      children: [
        ...
        /* @__PURE__ */ u4("div", {
          ...
          ref: popupRef,
          tabindex: 0,
          children: state.candidates.map((complIdx, idx) =>
            /* @__PURE__ */ u4(
              "div",
              {
          ...
          /* @__PURE__ */ u4("details", {
            ...
            children: [
              ...
              pl.relPlatforms.tap(rel =>
                /* @__PURE__ */ u4(Entry, { title: "Platforms", children: rel.values.map(({ plat }) => plat && Pill(plat)) }),
              ),
              pl.relInfluencedBy.tap(rel =>
                /* @__PURE__ */ u4(Entry, { title: "Influenced By", children: rel.values.map(({ toPl }) => toPl && Pill(toPl)) }),
              ),
              pl.relInfluenced.tap(rel =>
                /* @__PURE__ */ u4(Entry, { title: "Influenced", children: rel.values.map(({ fromPl }) => fromPl && Pill(fromPl)) }),
              ),
              pl.relDialectOf.tap(rel =>
                /* @__PURE__ */ u4(Entry, { title: "Dialect Of", children: rel.values.map(({ toPl }) => toPl && Pill(toPl)) }),
              ),
              pl.relImplements.tap(rel =>
                /* @__PURE__ */ u4(Entry, { title: "Standard For", children: rel.values.map(({ toPl }) => toPl && Pill(toPl)) }),
              ),
              pl.relLicenses.tap(rel =>
                /* @__PURE__ */ u4(Entry, { title: "Licenses", children: rel.values.map(({ license }) => license && Pill(license)) }),
              ),
              pl.extensions.tap(extensions =>
                /* @__PURE__ */ u4(Entry, { title: "Extensions", children: extensions.map(name => Pill({ key: name, name, kind: "ext" })) }),
              ),
            ],
          }),
        ],
  ...
  function Entry({ title, children }) {
    return /* @__PURE__ */ u4(k, { children: [/* @__PURE__ */ u4("h3", { children: title }), /* @__PURE__ */ u4("p", { children })] });
  }
  function Pill({ key, kind, name }) {
    return /* @__PURE__ */ u4(
      "div",
      {
        ...
        "data-kind": kind,
        class:
          "-skew-y-2 mr-1 mb-3 inline-block bg-primary p-1.5 font-bold font-bold text-background text-sm shadow-lg shadow-secondary outline-2 outline-secondary",
        children: name,
      },
      key,
    );
