...
export function define(g: PlangsGraph) {
  g.tag.set("tag+better-c", {
    ...
    shortDesc:
      "Improves on C's performance and simplicity with added safety and modern features",
    extHomeURL:
      "https://web.archive.org/web/20141218090724/https://www.drdobbs.com/open-source/a-better-c/223000087",
    keywords: ["better-c"],
    links: [
      {
