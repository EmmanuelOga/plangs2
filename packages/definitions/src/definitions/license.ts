...
export function define(g: PlangsGraph) {
  ...
  g.nodes.license.set("lic+apache", {
  ...
  g.nodes.license.set("lic+artistic", {
  ...
  g.nodes.license.set("lic+cecill", {
    name: "CeCILL",
    keywords: ["cecill"],
  ...
  g.nodes.license.set("lic+gnu-gpl", {
  ...
  g.nodes.license.set("lic+public-domain", {
    name: "Public Domain",
  ...
  g.nodes.license.set("lic+python", {
