...
export function define(g: PlangsGraph) {
  g.community
    .set("comm+contextfree", {
      name: "Context Free",
      description:
        "Programming languages, including design, usage, implementation, and history.",
      extHomeURL: "https://contextfree.info/",
      links: [
        { title: "Bluesky", url: "https://contextfree.bsky.social/" },
        {
          title: "Taca App Runtime",
          url: "https://github.com/contextfreeinfo/taca",
        },
        {
          title: "Languish Trends",
