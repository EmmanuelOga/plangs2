...
export function define(g: PlangsGraph) {
  g.plang
    ...
    .relPlatform.add(["plat+apple", "plat+bsd", "plat+cross", "plat+embedded", "plat+linux", "plat+windows"])
    .relTag.add(["tag+app", "tag+automation", "tag+cli", "tag+editor", "tag+interpreters", "tag+scripting", "tag+shell"])
