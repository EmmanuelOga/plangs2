import type { PlangsGraph } from "@plangs/plangs";
  ...
  export function define(g: PlangsGraph) {
    g.nodes.pl.set("pl+mruby", {"name":"mruby","description":"mruby is an interpreter for the Ruby programming language with the intention of being lightweight and easily embeddable. The project is headed by Yukihiro Matsumoto, with over 100 contributors currently working on the project.","keywords":["mruby"],"extensions":[".rb"],"year":2012,"isMainstream":false,"extWikipediaPath":"Mruby","extHomeURL":"https://mruby.org/"})
