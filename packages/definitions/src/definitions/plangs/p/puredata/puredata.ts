...
export function define(g: PlangsGraph) {
  g.nodes.pl
    .set("pl+puredata", {
      ...
      websites: [
        { title: "Pure Data — Pd Community Site", href: "http://puredata.info/", kind: "other" },
        { title: "Pure Data - Wikipedia", href: "https://en.wikipedia.org/wiki/PureData", kind: "wikipedia" },
      ],
      extensions: [".pd"],
      year: 1996,
      isMainstream: true,
