...
export function define(g: PlangsGraph) {
  g.nodes.pl
    .set("pl+pure", {
      ...
      websites: [
        { title: "Pure Programming Language", href: "http://agraef.github.io/pure-lang", kind: "other" },
        { title: "Rewriting - Wikipedia", href: "https://en.wikipedia.org/wiki/Pure_(programming_language)", kind: "wikipedia" },
      ],
      extensions: [".pure"],
      year: 2008,
