...
export function define(g: PlangsGraph) {
  g.nodes.pl
    .set("pl+xslt", {
      ...
      keywords: ["xslt"],
      websites: [
        { title: "XSL Transformations (XSLT) Version 3.0", href: "https://www.w3.org/TR/xslt-30/", kind: "other" },
        { title: "XSLT - Wikipedia", href: "https://en.wikipedia.org/wiki/XSLT", kind: "wikipedia" },
      ],
      extensions: [".xslt"],
      year: 1998,
      isMainstream: true,
