...
export function define(g: PlangsGraph) {
  g.nodes.pl
    .set("pl+codemonkey", {
      ...
      websites: [
        { title: "Coding for Kids | Game-Based Programming", href: "https://www.codemonkey.com/", kind: "homepage" },
        { title: "CodeMonkey (software) - Wikipedia", href: "https://en.wikipedia.org/wiki/CodeMonkey_(software)", kind: "wikipedia" },
      ],
      year: 2014,
      isMainstream: false,
