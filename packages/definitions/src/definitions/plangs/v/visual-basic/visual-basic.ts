...
export function define(g: PlangsGraph) {
  g.nodes.pl
    .set("pl+visual-basic", {
      ...
      websites: [
        { title: "Visual Basic docs - get started, tutorials, reference.", href: "https://docs.microsoft.com/dotnet/visual-basic/", kind: "other" },
        { title: "Visual Basic (.NET) - Wikipedia", href: "https://en.wikipedia.org/wiki/Visual_Basic_(.NET)", kind: "wikipedia" },
      ],
      extensions: [".vb"],
      year: 2001,
      isMainstream: true,
