...
export function define(g: PlangsGraph) {
  g.nodes.pl
    .set("pl+gforth", {
      ...
      websites: [
        { title: "Gforth - GNU Project - Free Software Foundation", href: "http://gnu.org/s/gforth/", kind: "homepage" },
        { title: "Gforth - Wikipedia", href: "https://en.wikipedia.org/wiki/Gforth", kind: "wikipedia" },
      ],
      year: 1992,
      isMainstream: false,
      releases: [
