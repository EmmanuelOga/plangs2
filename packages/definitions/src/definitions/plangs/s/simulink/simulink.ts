...
export function define(g: PlangsGraph) {
  g.nodes.pl
    .set("pl+simulink", {
      ...
      websites: [
        { title: "Simulink - Simulation and Model-Based Design", href: "https://www.mathworks.com/products/simulink.html", kind: "homepage" },
        { title: "Simulink - Wikipedia", href: "https://en.wikipedia.org/wiki/Simulink", kind: "wikipedia" },
      ],
      year: 1984,
      isMainstream: true,
