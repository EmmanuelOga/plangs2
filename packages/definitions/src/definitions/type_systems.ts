...
export function define(g: PlangsGraph) {
  ...
  g.n_tsystems.set("tsys+dependent", {
  ...
  g.n_tsystems.set("tsys+inferred", {
  ...
  g.n_tsystems.set("tsys+manifest", {
  ...
  g.n_tsystems.set("tsys+optional", {
  ...
  g.n_tsystems.set("tsys+polymorphic", {
  ...
  g.n_tsystems.set("tsys+structural", {
  ...
  g.n_tsystems.set("tsys+uniqueness", {
  ...
  g.n_tsystems.set("tsys+algebraic", {
