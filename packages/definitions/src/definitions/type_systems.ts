...
export function define(g: PlangsGraph) {
  ...
  g.n_tsystem.set("tsys+dependent", {
  ...
  g.n_tsystem.set("tsys+polymorphic", {
  ...
  g.n_tsystem.set("tsys+structural", {
