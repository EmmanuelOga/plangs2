...
export function define(g: PlangsGraph) {
  g.nodes.paradigm.set("para+agents", {
    name: "Agent-oriented",
    keywords: ["agent"],
  ...
  g.nodes.paradigm.set("para+array", {
  ...
  g.nodes.paradigm.set("para+aspect", {
  ...
  g.nodes.paradigm.set("para+assembly", {
    name: "Assembly",
    keywords: ["assembly"],
    description:
  ...
  g.nodes.paradigm.set("para+async", {
  ...
  g.nodes.paradigm.set("para+bidirectional", {
  ...
  g.nodes.paradigm.set("para+compiled", {
  ...
  g.nodes.paradigm.set("para+concatenative", {
  ...
  g.nodes.paradigm.set("para+concurrent", {
    name: "Concurrent",
  ...
  g.nodes.paradigm.set("para+constraint", {
  ...
  g.nodes.paradigm.set("para+contracts", {
  ...
  g.nodes.paradigm.set("para+data-driven", {
  ...
  g.nodes.paradigm.set("para+data-exchange", {
    name: "Data Exchange",
  ...
  g.nodes.paradigm.set("para+data-hiding", {
  ...
  g.nodes.paradigm.set("para+dataflow", {
  ...
  g.nodes.paradigm.set("para+declarative", {
  ...
  g.nodes.paradigm.set("para+distributed", {
  ...
  g.nodes.paradigm.set("para+educational", {
  ...
  g.nodes.paradigm.set("para+embedded", {
  ...
  g.nodes.paradigm.set("para+esoteric", {
  ...
  g.nodes.paradigm.set("para+event-driven", {
  ...
  g.nodes.paradigm.set("para+exp-oriented", {
  ...
  g.nodes.paradigm.set("para+expert-system", {
    name: "Expert System",
  ...
  g.nodes.paradigm.set("para+extensible", {
  ...
  g.nodes.paradigm.set("para+functional", {
  ...
  g.nodes.paradigm.set("para+general-purpose", {
  ...
  g.nodes.paradigm.set("para+imperative", {
  ...
  g.nodes.paradigm.set("para+interpreted", {
  ...
  g.nodes.paradigm.set("para+language-oriented", {
  ...
  g.nodes.paradigm.set("para+lazy", {
  ...
  g.nodes.paradigm.set("para+logic", {
  ...
  g.nodes.paradigm.set("para+low-code", {
  ...
  g.nodes.paradigm.set("para+macro", {
  ...
  g.nodes.paradigm.set("para+message-passing", {
  ...
  g.nodes.paradigm.set("para+metaprogramming", {
  ...
  g.nodes.paradigm.set("para+modular", {
  ...
  g.nodes.paradigm.set("para+multi", {
    name: "Multi-paradigm",
  ...
  g.nodes.paradigm.set("para+multi-dispatch", {
  ...
  g.nodes.paradigm.set("para+natural-language", {
  ...
  g.nodes.paradigm.set("para+parallel", {
  ...
  g.nodes.paradigm.set("para+pattern-matching", {
  ...
  g.nodes.paradigm.set("para+pipeline", {
  ...
  g.nodes.paradigm.set("para+point-free", {
  ...
  g.nodes.paradigm.set("para+procedural", {
  ...
  g.nodes.paradigm.set("para+process-oriented", {
  ...
  g.nodes.paradigm.set("para+protocol", {
  ...
  g.nodes.paradigm.set("para+prototype", {
  ...
  g.nodes.paradigm.set("para+quantum", {
  ...
  g.nodes.paradigm.set("para+query", {
    name: "Query Language",
    keywords: ["query"],
  ...
  g.nodes.paradigm.set("para+reactive", {
  ...
  g.nodes.paradigm.set("para+real-time", {
  ...
  g.nodes.paradigm.set("para+reflective", {
  ...
  g.nodes.paradigm.set("para+rewriting", {
    name: "Term Rewriting",
  ...
  g.nodes.paradigm.set("para+rules", {
  ...
  g.nodes.paradigm.set("para+scientific", {
  ...
  g.nodes.paradigm.set("para+scripting", {
  ...
  g.nodes.paradigm.set("para+shared-memory", {
    name: "Shared Memory",
  ...
  g.nodes.paradigm.set("para+simulation", {
  ...
  g.nodes.paradigm.set("para+stack-oriented", {
  ...
  g.nodes.paradigm.set("para+structured", {
  ...
  g.nodes.paradigm.set("para+symbolic", {
  ...
  g.nodes.paradigm.set("para+synchronous", {
  ...
  g.nodes.paradigm.set("para+validation", {
  ...
  g.nodes.paradigm.set("para+visual", {
