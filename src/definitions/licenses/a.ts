...
export function define(g: PlangsGraph) {
  ...
  lb.declare(
    ...
    [{"kind":"wikipedia","title":"Academic Free License","href":"https://en.wikipedia.org/wiki/Academic_Free_License"}]);
  ...
  lb.declare(
    ...
    [{"kind":"wikipedia","title":"Apache-2.0-with-LLVM-Exception","href":"https://en.wikipedia.org/wiki/Apache-2.0-with-LLVM-Exception"}]);
