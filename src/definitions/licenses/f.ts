...
export function define(g: PlangsGraph) {
  ...
  lb.declare(
    ...
    [{"kind":"wikipedia","title":"free and open-source","href":"https://en.wikipedia.org/wiki/Free_and_open_source_software"}]);
  ...
  lb.declare(
    ...
    [{"kind":"wikipedia","title":"Freely redistributable software","href":"https://en.wikipedia.org/wiki/Freely_redistributable_software"}]);
