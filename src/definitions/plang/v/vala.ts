...
export function define(g: PlangsGraph) {
   ...
   plb.addImages(pl, [{"kind":"logo","url":"https://upload.wikimedia.org/wikipedia/commons/9/92/Vala_Logo.svg"}]);
  ...
  },
  {
   ...
   plb.addPeople(pl, [
  [
    "person+Jurg-Billeter",
    "designer"
  ],
  [
    "person+Raffaele-Sandrini",
    "designer"
  ],
  [
    "person+Rico-Tzschichholz",
    "designer"
  ]
]);
  ...
  "para+structured"
   ...
   plb.addInfluences(pl, ["pl+Boo","pl+C","pl+C-Plus-Plus","pl+C-Sharp","pl+D","pl+Java"]);

   plb.addInfluenced(pl, ["pl+Boo","pl+C","pl+D-programming-language","pl+Java"]);
