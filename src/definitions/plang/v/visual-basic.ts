...
export function define(g: PlangsGraph) {
   ...
   plb.addImages(pl, [{"kind":"logo","url":"https://upload.wikimedia.org/wikipedia/en/thumb/e/e4/Visual_Basic_6.0_logo.png/210px-Visual_Basic_6.0_logo.png"}]);
  ...
  {
    "kind": "homepage",
    "title": "learn.microsoft.com/en-us/previous-versions/visualstudio/visual-basic-6/visual-basic-6.0-documentation",
  ...
  "pl+Xojo"
   ...
   plb.addInfluenced(pl, ["pl+B4x","pl+BASIC","pl+Gambas","pl+Visual-Basic-for-Applications"]);

   plb.addReleases(pl, [{"version":"unknown","date":"1991-01-01","kind":"first"}]);
}