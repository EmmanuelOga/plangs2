...
export function define(g: PlangsGraph) {
   ...
   plb.addImages(pl, [{"kind":"logo","url":"https://upload.wikimedia.org/wikipedia/commons/e/e8/V_Logo_SVG.svg"}]);
  ...
  "platf+x86-64"
   ...
   plb.addInfluences(pl, ["pl+Go","pl+Kotlin","pl+Oberon","pl+Python","pl+Rust","pl+Swift"]);
