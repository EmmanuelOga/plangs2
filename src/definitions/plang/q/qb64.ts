...
export function define(g: PlangsGraph) {
   ...
   plb.addImages(pl, [{"kind":"logo","url":"https://upload.wikimedia.org/wikipedia/commons/f/f5/QB64-1-4-logo-hd-transparency.svg"}]);
  ...
  },
  {
   ...
   plb.addPlatforms(pl, ["platf+Linux","platf+Microsoft-Windows","platf+macOS"]);
