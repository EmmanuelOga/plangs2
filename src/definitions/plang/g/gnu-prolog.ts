...
export function define(g: PlangsGraph) {
   ...
   plb.addImages(pl, [{"kind":"logo","url":"https://upload.wikimedia.org/wikipedia/en/2/22/Heckert_GNU_white.svg"}]);
  ...
  },
  {
   ...
   plb.addReleases(pl, [{"version":"1.5.0","date":"2021-07-08","kind":"stable"}]);
}