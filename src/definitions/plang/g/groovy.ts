...
export function define(g: PlangsGraph) {
   ...
   plb.addImages(pl, [{"kind":"logo","url":"https://upload.wikimedia.org/wikipedia/commons/3/36/Groovy-logo.svg"}]);
  ...
  "para+scripting"
   ...
   plb.addTypeSystems(pl, ["tsys+duck","tsys+dynamic","tsys+static","tsys+strong"]);
   ...
   plb.addInfluences(pl, ["pl+Java","pl+Kotlin","pl+Python","pl+Ruby","pl+Smalltalk"]);
