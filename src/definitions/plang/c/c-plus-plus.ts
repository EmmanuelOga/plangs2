...
export function define(g: PlangsGraph) {
   ...
   plb.addImages(pl, [{"kind":"logo","url":"https://upload.wikimedia.org/wikipedia/commons/1/18/ISO_C%2B%2B_Logo.svg"}]);
  ...
  "para+objects"
   ...
   plb.addTypeSystems(pl, ["tsys+inferred","tsys+nominative","tsys+static","tsys+strong"]);
