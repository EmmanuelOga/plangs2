...
export function define(g: PlangsGraph) {
   ...
   plb.addImages(pl, [{"kind":"logo","url":"https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/JavaScript_code.png/300px-JavaScript_code.png"}]);
  ...
  "para+objects"
   ...
   plb.addImplementations(pl, ["pl+Chakra","pl+JavaScriptCore","pl+SpiderMonkey","pl+V8"]);
