...
export function define(g: PlangsGraph) {
   ...
   plb.addImages(pl, [{"kind":"logo","url":"https://upload.wikimedia.org/wikipedia/commons/1/1f/Julia_Programming_Language_Logo.svg"}]);
  ...
  "platf+x86-64"
   ...
   plb.addImplementations(pl, ["pl+C","pl+C-Plus-Plus","pl+LLVM","pl+Scheme"]);
