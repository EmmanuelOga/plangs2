...
export function define(g: PlangsGraph) {
   ...
   plb.addImages(pl, [{"kind":"logo","url":"https://upload.wikimedia.org/wikipedia/commons/4/4c/Xtend-logo-c.png"}]);
  ...
  },
  {
   ...
   plb.addPeople(pl, [
  [
    "person+Sebastian-Zarnekow",
    "designer"
  ],
  [
    "person+Sven-Efftinge",
    "designer"
  ]
]);
   ...
   plb.addParadigms(pl, ["para+functional","para+imperative","para+objects"]);
