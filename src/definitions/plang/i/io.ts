...
export function define(g: PlangsGraph) {
   ...
   plb.addImages(pl, [{"kind":"logo","url":"https://upload.wikimedia.org/wikipedia/commons/2/26/Io-logo.svg"}]);
  ...
  },
  {
   ...
   plb.addPeople(pl, [
  [
    "person+Jeremy-Tregunna",
    "designer"
  ],
  [
    "person+Jonathan-Wright",
    "designer"
  ],
  [
    "person+Steve-Dekorte",
    "designer"
  ]
]);
