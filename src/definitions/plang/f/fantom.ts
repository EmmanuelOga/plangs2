...
export function define(g: PlangsGraph) {
   ...
   plb.addImages(pl, [{"kind":"logo","url":"https://upload.wikimedia.org/wikipedia/commons/8/8c/Fantom-logo.png"}]);
  ...
  },
  {
   ...
   plb.addPeople(pl, [["person+Andy-Frank","designer"],["person+Brian-Frank","designer"]]);
   ...
   plb.addInfluences(pl, ["pl+C-Sharp","pl+Erlang","pl+Java","pl+Ruby","pl+Scala"]);
