...
export function define(g: PlangsGraph) {
   ...
   plb.addImages(pl, [{"kind":"logo","url":"https://upload.wikimedia.org/wikipedia/commons/c/c3/Python-logo-notext.svg"}]);
  ...
  "para+structured"
   ...
   plb.addTypeSystems(pl, ["tsys+duck","tsys+dynamic","tsys+optional","tsys+strong"]);
