...
export function define(g: PlangsGraph) {
   ...
   plb.addImages(pl, [{"kind":"logo","url":"https://upload.wikimedia.org/wikipedia/commons/8/82/Adobe_PostScript_3_logo.svg"}]);

   plb.addWebsites(pl, [{"kind":"wikipedia","title":"PostScript","href":"https://en.wikipedia.org/wiki/PostScript"}]);
