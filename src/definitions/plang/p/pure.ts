...
export function define(g: PlangsGraph) {
   ...
   plb.addImages(pl, [{"kind":"logo","url":"https://upload.wikimedia.org/wikipedia/en/thumb/5/5a/Pure_lang_logo.png/121px-Pure_lang_logo.png"}]);
  ...
  },
  {
   ...
   plb.addParadigms(pl, ["para+declarative","para+functional","para+term-rewriting"]);
  ...
  "platf+macOS"
   ...
   plb.addInfluences(pl, ["pl+Alice","pl+Haskell","pl+Lisp","pl+MATLAB","pl+Q"]);
