...
export function define(g: PlangsGraph) {
   ...
   plb.addImages(pl, [{"kind":"logo","url":"https://upload.wikimedia.org/wikipedia/commons/c/cf/Lua-Logo.svg"}]);
  ...
  "para+scripting"
   ...
   plb.addInfluences(pl, ["pl+C-Plus-Plus","pl+CLU","pl+Modula","pl+SNOBOL","pl+Scheme"]);
