...
export function define(g: PlangsGraph) {
	...
	lb.define("person+anthony-james-barr", "Anthony James Barr", {
		websites: [
			{
				title: "Anthony James Barr",
				href: "https://en.wikipedia.org/wiki/Anthony_James_Barr",
				kind: "wikipedia",
			},
		],
	});
	...
	lb.define("person+don-syme", "Don Syme", {
		websites: [
			{
				title: "Don Syme",
				href: "https://en.wikipedia.org/wiki/Don_Syme",
				kind: "wikipedia",
			},
		],
	});
