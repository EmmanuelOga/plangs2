...
export function define(g: PlangsGraph) {
  ...
  lb.define("pl+P4", "P4", {
    ...
    references: {
      stable_release: [
        {
          href: "https://p4.org/p4-spec/docs/P4-16-v1.2.2.html",
  ...
  lb.define("pl+PARI-SlashGP", "PARI/GP", {
    ...
    images: [
      { kind: "logo", url: "https://upload.wikimedia.org/wikipedia/commons/2/26/PARI-GP_logo.svg" },
    ],
    references: {
      stable_release: [
        {
  ...
  lb.define("pl+PeachPie", "PeachPie", {
    ...
    references: {
      initial_release: [
        {
          href: "https://github.com/peachpiecompiler/peachpie/releases",
          title: "PeachPie Compiler pre-release",
        },
      ],
      written_in: [
        {
          href: "https://github.com/peachpiecompiler/peachpie/releases",
          title: "PeachPie repository",
        },
      ],
      license: [
        {
  ...
  lb.define("pl+PHP", "PHP", {
    ...
    images: [
      { kind: "logo", url: "https://upload.wikimedia.org/wikipedia/commons/2/27/PHP-logo.svg" },
    ],
    references: {
      first_appeared: [
        {
      ...
      stable_release: [
        {
          href: "https://www.php.net/archive/2024.php#2024-06-06-2",
          title: "PHP: News Archive - 2024",
        },
      ],
      typing_discipline: [
        {
  ...
  lb.define("pl+PicoLisp", "PicoLisp", {
    ...
    extensions: [".l"],
    references: {
      dialects: [{ href: "https://software-lab.de/down.html", title: "PicoLisp Download" }],
    },
  ...
  lb.define("pl+PL-SlashpgSQL", "PL/pgSQL", {
    ...
    people: [["person+Jan-Wieck", "designer"]],
  ...
  lb.define("pl+PostScript", "PostScript", {
    ...
    references: {
      influenced_by: [{ href: "https://doi.org/10.1109%2F6.4550", title: "10.1109/6.4550" }],
    },
    people: [
  ...
  lb.define("pl+POV-Ray", "POV-Ray", {
    ...
    references: {
      ...
      stable_release: [
        {
          href: "https://github.com/POV-Ray/povray/releases/tag/v3.7.0.0",
          title: "Release 3.7.0.0",
        },
      ],
      preview_release: [
        {
  ...
  lb.define("pl+PowerShell", "PowerShell", {
    ...
    references: {
      ...
      license: [
        { href: "https://github.com/PowerShell/PowerShell", title: "PowerShell for every system!" },
      ],
      influenced_by: [
        {
  ...
  lb.define("pl+Python", "Python", {
    ...
    references: {
      ...
      influenced_by: [
        ...
        {
          href: "https://citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.38.2023",
          title: "10.1.1.38.2023",
        },
        {
      ...
      influenced: [
        {
          href: "https://web.archive.org/web/20200612100004/http://coffeescript.org/",
          title: "CoffeeScript",
        },
        {
