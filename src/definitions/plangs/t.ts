...
export function define(g: PlangsGraph) {
  ...
  lb.define("pl+Tcl", "Tcl", {
    ...
    images: [
      { kind: "logo", url: "https://upload.wikimedia.org/wikipedia/commons/e/eb/Tcl-powered.svg" },
    ],
    references: {
      developer: [
        { href: "http://www.tcl.tk/community/coreteam", title: "Tcl/Tk Core Development" },
      ],
      stable_release: [
        {
      ...
      license: [
        {
          href: "http://www.tcl-lang.org/software/tcltk/license.html",
          title: "Tcl/Tk License Terms",
        },
      ],
      filename_extensions: [
        {
          href: "http://docs.activestate.com/tdk/4.1/Compiler.html",
          title: "Tcl Dev Kit – Compiler",
        },
      ],
      influenced: [
        {
  ...
  lb.define("pl+TypeScript", "TypeScript", {
    ...
    images: [
      { kind: "logo", url: "https://upload.wikimedia.org/wikipedia/commons/f/f5/Typescript.svg" },
    ],
    references: {
      first_appeared: [
        {
      ...
      influenced_by: [
        {
          href: "https://fsharp.org/history/hopl-final/hopl-fsharp.pdf",
