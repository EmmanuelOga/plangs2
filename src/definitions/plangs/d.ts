...
export function define(g: PlangsGraph) {
  ...
  lb.define("pl+Dart", "Dart", {
    ...
    references: {
      ...
      stable_release: [
        { href: "https://github.com/dart-lang/sdk/releases/tag/3.4.3", title: "Release 3.4.3" },
      ],
      typing_discipline: [
        { href: "https://dart.dev/guides/language/sound-dart", title: "The Dart type system" },
      ],
      influenced_by: [
        {
  ...
  lb.define("pl+DataFlex", "DataFlex", {
    ...
    references: {
      ...
      operating_system: [
        {
          href: "https://www.pcmag.com/encyclopedia/term/40897/dataflex",
          title: "Definition of: DataFlex",
        },
