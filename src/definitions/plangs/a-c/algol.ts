...
export function define(g: PlangsGraph) {
  ...
  lb.define(
    ...
    },
    {
      ...
      implementations: ["pl+algol", "pl+flacc", "pl+odra", "pl+bliss", "pl+pl360", "pl+assembly"],
      influences: ["pl+fortran", "pl+plankalkul", "pl+superplan", "pl+algol", "pl+pl360", "pl+speedcoding"],
      paradigms: ["para+imperative", "para+structured", "para+multi", "para+concurrent"],
      people: [
