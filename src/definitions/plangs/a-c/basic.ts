...
export function define(g: PlangsGraph) {
  ...
  lb.define(
    ...
    },
    {
      ...
      implementations: ["pl+.net-framework-sdk", "pl+basic", "pl+mono", "pl+ms-visual-studio", "pl+roslyn"],
      influences: [
        "pl+algol",
        "pl+basic",
        "pl+c",
      ...
      typeSystems: ["tsys+dynamic", "tsys+nominative", "tsys+safe", "tsys+static", "tsys+strong", "tsys+weak"],
    },
  );
