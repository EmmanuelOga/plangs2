...
export function define(g: PlangsGraph) {
  ...
  lb.define(
    ...
    },
    {
      ...
      implementations: ["pl+ms-visual-studio", "pl+basic", "pl+assembly", "pl+mos-6502", "pl+qb64"],
      influences: [
        "pl+basic",
        "pl+li-chen-wang",
        "pl+fortran",
      ...
      typeSystems: ["tsys+static", "tsys+weak", "tsys+dynamic", "tsys+strong"],
    },
  );
  ...
  lb.define(
    ...
    "Xojo",
    {
      ...
      releases: [
        { version: "unknown", kind: "stable" },
        { version: "3.1", date: "2023-10-25", kind: "stable" },
      ],
    },
