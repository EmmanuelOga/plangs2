...
export function define(g: PlangsGraph) {
  ...
  lb.define("pl+Gambit", "Gambit", {
    ...
    references: {
      stable_release: [
        { href: "https://gambitscheme.org/latest/", title: "Gambit Scheme - Gambit 4.9.4" },
      ],
    },
  ...
  lb.define("pl+Gforth", "Gforth", {
    ...
    images: [
      { kind: "logo", url: "https://upload.wikimedia.org/wikipedia/commons/a/a5/Gforth_Logo.png" },
    ],
    references: {
      initial_release: [
        {
      ...
      stable_release: [
        {
          href: "https://www.gnu.org/software/gforth/",
          title: "Gforth - GNU Project - Free Software Foundation",
        },
      ],
    },
    releases: [
  ...
  lb.define("pl+Gleam", "Gleam", {
    ...
    references: {
      ...
      stable_release: [
        { href: "https://github.com/gleam-lang/gleam/releases/tag/v1.1.0", title: "Release 1.1.0" },
      ],
      ...
      license: [
        {
          href: "https://github.com/gleam-lang/gleam/blob/main/LICENCE",
          title: "Gleam License File",
        },
      ],
      influenced_by: [
        {
  ...
  lb.define("pl+GNAT", "GNAT", {
    ...
    images: [
      { kind: "logo", url: "https://upload.wikimedia.org/wikipedia/en/2/22/Heckert_GNU_white.svg" },
    ],
    releases: [
    ...
    references: {
      stable_release: [
        {
          href: "https://www.gnu.org/software/gcc/releases.html",
          title: "GCC Releases - GNU Project",
        },
        {
          href: "https://www.adacore.com/press/gnat-pro-7-4",
          title: "AdaCore Releases GNAT Pro 7.4",
        },
      ],
      license: [
        {
          href: "https://www.gnu.org/licenses/gcc-exception.html",
  ...
  lb.define("pl+GNU-Octave", "GNU Octave", {
    ...
    people: [["person+John-W-Eaton", "designer"]],
  ...
  lb.define("pl+GNU-Prolog", "GNU Prolog", {
    ...
    references: {
      developers: [
        { href: "http://cri-dist.univ-paris1.fr/diaz/", title: "Daniel Diaz's Home Page" },
      ],
    },
  ...
  lb.define("pl+Go", "Go", {
    ...
    images: [
      { kind: "logo", url: "https://upload.wikimedia.org/wikipedia/commons/0/05/Go_Logo_Blue.svg" },
    ],
    references: {
      paradigm: [
        {
        ...
        {
          href: "https://talks.golang.org/2012/chat.slide#5",
          title: "Go: code that grows with grace",
        },
      ],
  ...
  lb.define("pl+Gosu", "Gosu", {
    ...
    references: {
      stable_release: [
        {
          href: "https://github.com/gosu-lang/gosu-lang/releases/tag/v1.17.10",
          title: "Release 1.17.10",
        },
      ],
    },
  ...
  lb.define("pl+Groovy", "Groovy", {
    ...
    images: [
      { kind: "logo", url: "https://upload.wikimedia.org/wikipedia/commons/3/36/Groovy-logo.svg" },
    ],
    releases: [
    ...
    references: {
      stable_release: [
        {
          href: "https://github.com/apache/groovy/releases/tag/GROOVY_4_0_21",
          title: "Release 4.0.21",
        },
      ],
      preview_release: [
        { href: "https://github.com/apache/groovy/releases", title: "Releases - apache/groovy" },
      ],
    },
    people: [
