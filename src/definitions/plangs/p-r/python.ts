...
export function define(g: PlangsGraph) {
			...
			websites: [
				{
					kind: "wikipedia",
					title: "CircuitPython",
					href: "https://en.wikipedia.org/wiki/CircuitPython",
				},
			],
			images: [
				{
			...
			websites: [
				{
					kind: "wikipedia",
					title: "MicroPython",
					href: "https://en.wikipedia.org/wiki/MicroPython",
				},
			],
			images: [
				{
					kind: "logo",
					url: "https://upload.wikimedia.org/wikipedia/commons/a/a7/MicroPython_new_logo.svg",
				},
			],
		...
		websites: [
			{
				kind: "wikipedia",
				title: "PyPy",
				href: "https://en.wikipedia.org/wiki/PyPy",
			},
			{
				kind: "wikipedia",
				title: "RPython",
	...
	lb.define(
		...
		{
			influences: ["pl+dis-virtual-machine", "pl+limbo"],
			licenses: ["lic+python-foundation"],
		},
	);
}
