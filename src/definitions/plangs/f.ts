...
export function define(g: PlangsGraph) {
  ...
  lb.define("pl+Fantom", "Fantom", {
    ...
    images: [
      { kind: "logo", url: "https://upload.wikimedia.org/wikipedia/commons/8/8c/Fantom-logo.png" },
    ],
    references: {
      first_appeared: [
        {
          href: "http://fantom.org/sidewalk/topic/355",
          title: "Blog post about history of Fantom",
        },
      ],
      stable_release: [{ href: "https://www.fantom.org/forum/topic/2892", title: "Fantom" }],
      license: [
        {
          href: "http://fantom.org/doc/docIntro/Faq.html",
          title: "FAQ of Fandoc language website",
        },
      ],
    },
    releases: [
  ...
  lb.define("pl+FAUST", "FAUST", {
    ...
    references: {
      stable_release: [
        {
          href: "https://github.com/grame-cncm/faust/releases",
          title: "Releases · grame-cncm/faust · GitHub",
        },
      ],
    },
    licenses: ["lic+gpl"],
  ...
  lb.define("pl+Flix", "Flix", {
    ...
    references: {
      license: [
        {
          href: "https://github.com/flix/flix/blob/master/LICENSE.md",
  ...
  lb.define("pl+Futhark", "Futhark", {
    ...
    references: {
      developer: [{ href: "https://futhark-lang.org/license.html", title: "License" }],
    },
