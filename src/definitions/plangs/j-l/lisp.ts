...
export function define(g: PlangsGraph) {
  ...
  lb.define(
    ...
    },
    {
      ...
      influences: ["pl+lisp", "pl+maclisp", "pl+scheme", "pl+interlisp", "pl+mdl", "pl+zetalisp"],
      paradigms: [
        "para+multi",
        "para+imperative",
        "para+functional",
  ...
  lb.define(
    ...
    },
    {
      ...
      influences: ["pl+armed-bear-common-lisp", "pl+common-lisp", "pl+eulisp", "pl+le-lisp", "pl+scheme", "pl+lelisp"],
