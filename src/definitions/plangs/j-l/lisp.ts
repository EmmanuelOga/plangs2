...
export function define(g: PlangsGraph) {
  ...
  lb.define(
    ...
    },
    {
      ...
      people: [["person+john-foderaro", { role: "designer" }]],
  ...
  lb.define(
    ...
    },
    {
      ...
      people: [["person+david-betz", { role: "designer" }]],
  ...
  lb.define(
    ...
    },
    {
      ...
      people: [
        ["person+dan-weinreb", { role: "designer" }],
        ["person+david-a-moon", { role: "designer" }],
        ["person+guy-steele", { role: "designer" }],
        ["person+kent-pitman", { role: "designer" }],
        ["person+richard-p-gabriel", { role: "designer" }],
        ["person+scott-fahlman", { role: "designer" }],
      ],
  ...
  lb.define(
    ...
    },
    {
      ...
      people: [
        ...
        ["person+richard-stallman", { role: "designer" }],
      ],
  ...
  lb.define(
    ...
    },
    {
      ...
      people: [
        ["person+daniel-kochmanski", { role: "developer" }],
        ["person+giuseppe-attardi", { role: "designer" }],
        ["person+marius-gerbershagen", { role: "developer" }],
      ],
  ...
  lb.define(
    ...
    },
    {
      ...
      people: [["person+richard-fateman", { role: "designer" }]],
  ...
  lb.define(
    ...
    },
    {
      ...
      paradigms: ["para+functional", "para+imperative", "para+meta", "para+multi", "para+reflection"],
      people: [
        ["person+emmanuel-st-james", { role: "designer" }],
        ["person+jean-marie-hullot", { role: "designer" }],
        ["person+jerome-chailloux", { role: "designer" }],
        ["person+matthieu-devin", { role: "designer" }],
      ],
      platforms: [
        "platf+bsd",
        "platf+dec",
  ...
  lb.define(
    ...
    },
    {
      ...
      people: [
        ["person+john-mccarthy", { role: "designer" }],
        ["person+steve-russell", { role: "developer" }],
      ],
      typeSystems: ["tsys+dynamic", "tsys+strong"],
    },
  );
  ...
  lb.define(
    ...
    },
    {
      ...
      paradigms: ["para+functional", "para+imperative", "para+meta", "para+multi", "para+reflection"],
      people: [["person+richard-greenblatt", { role: "designer" }]],
      typeSystems: ["tsys+dynamic", "tsys+strong"],
    },
  );
  ...
  lb.define(
    ...
    },
    {
      ...
      people: [["person+robert-h-halstead-jr", { role: "designer" }]],
  ...
  lb.define(
    ...
    },
    {
      ...
      licenses: ["lic+gpl"],
      people: [["person+lutz-mueller", { role: "designer" }]],
  ...
  lb.define(
    ...
    {
      implementations: ["pl+c"],
      influences: ["pl+islisp", "pl+lelisp", "pl+lisp"],
      licenses: ["lic+proprietary"],
      paradigms: ["para+functional", "para+imperative", "para+meta", "para+multi", "para+objects", "para+reflection"],
      people: [["person+christian-jullien", { role: "designer" }]],
      platforms: [
        "platf+aarch64",
        "platf+arm",
        "platf+bsd",
  ...
  lb.define(
    ...
    },
    {
      ...
      people: [["person+alexander-burger", { role: "designer" }]],
  ...
  lb.define(
    ...
    },
    {
      ...
      people: [
        ["person+daniel-weinreb", { role: "designer" }],
        ["person+david-a-moon", { role: "designer" }],
        ["person+lisp-machines", { role: "developer" }],
        ["person+richard-stallman", { role: "designer" }],
      ],
    },
  );
