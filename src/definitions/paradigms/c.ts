...
export function define(g: PlangsGraph) {
  ...
  lb.declare(
    ...
    "component-based",
    [{"kind":"wikipedia","title":"component-based","href":"https://en.wikipedia.org/wiki/Component-based_software_engineering"}]);
  ...
  lb.declare(
    ...
    [{"kind":"wikipedia","title":"communicating sequential processes","href":"https://en.wikipedia.org/wiki/Communicating_sequential_processes"}]);
